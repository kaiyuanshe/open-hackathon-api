...
namespace Kaiyuanshe.OpenHackathon.Server.Controllers
{
    public class AnnouncementController : HackathonControllerBase
    {
        ...
        [Route("hackathon/{hackathonName}/announcement/{announcementId}")]
        [Authorize(Policy = AuthConstant.PolicyForSwagger.HackathonAdministrator)]
        public async Task<object> DeleteAnnouncement(
            [FromRoute, Required, RegularExpression(ModelConstants.HackathonNamePattern)] string hackathonName,
            [FromRoute, Required, Guid] string announcementId,
            CancellationToken cancellationToken)
        {
            ...
            await ActivityLogManagement.OnHackathonEvent(hackathon.Name, CurrentUserId, ActivityLogType.deleteAnnouncement, args, cancellationToken);
            return NoContent();
        }
        #endregion
    }
