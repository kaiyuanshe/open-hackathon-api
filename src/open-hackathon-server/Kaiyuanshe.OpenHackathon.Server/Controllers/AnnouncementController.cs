...
namespace Kaiyuanshe.OpenHackathon.Server.Controllers
{
    public class AnnouncementController : HackathonControllerBase
    {
        ...
        /// <param name="hackathonName" example="foo">Name of hackathon. Case-insensitive.
        /// Must contain only letters and/or numbers, length between 1 and 100</param>
        /// <param name="announcementId" example="fa896287-ab7a-4429-a84d-701d8d312a28">Unique id of organizer. Generated by server. Please call the list api to query the id.</param>
