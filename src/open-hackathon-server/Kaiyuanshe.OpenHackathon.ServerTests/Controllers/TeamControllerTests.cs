...
namespace Kaiyuanshe.OpenHackathon.ServerTests.Controllers
{
    ...
    public class TeamControllerTests
    {
        ...
        public async Task UpdateTeam_TeamNotFound()
        {
            ...
            moqs.TeamManagement.Setup(t => t.GetTeamByIdAsync("foo", "tid", default))
        ...
        public async Task UpdateTeam_TeamNameTaken()
        {
            ...
            // moq
            var moqs = new Moqs();
            moqs.HackathonManagement.Setup(p => p.GetHackathonEntityByNameAsync("foo", default)).ReturnsAsync(hackathon); var teamManagement = new Mock<ITeamManagement>();
            moqs.TeamManagement.Setup(t => t.GetTeamByIdAsync("foo", "tid", default)).ReturnsAsync(teamEntity);
            moqs.TeamManagement.Setup(t => t.GetTeamByNameAsync("foo", "dn2", default)).ReturnsAsync(teamByName);
        ...
        public async Task UpdateTeam_Succeeded(string newDisplayName, bool checkName)
        {
            ...
            TeamEntity teamEntity = new TeamEntity { DisplayName = "dn" };
            TeamEntity updated = new TeamEntity { RowKey = "rk", Description = "updated", DisplayName = "dn2", CreatorId = "uid" };
            ...
            moqs.TeamManagement.Setup(t => t.UpdateTeamAsync(parameter, teamEntity, default)).ReturnsAsync(updated);
            moqs.AuthorizationService.Setup(m => m.AuthorizeAsync(It.IsAny<ClaimsPrincipal>(), teamEntity, AuthConstant.Policy.TeamAdministrator)).ReturnsAsync(authResult);
            moqs.UserManagement.Setup(u => u.GetUserByIdAsync("uid", default)).ReturnsAsync(user);
            moqs.ActivityLogManagement.Setup(a => a.LogHackathonActivity("foo", "", ActivityLogType.updateTeam, It.IsAny<object>(), null, default));
            moqs.ActivityLogManagement.Setup(a => a.LogTeamActivity("foo", "rk", "", ActivityLogType.updateTeam, It.IsAny<object>(), null, default));
            moqs.ActivityLogManagement.Setup(a => a.LogUserActivity("", "foo", "", ActivityLogType.updateTeam, It.IsAny<object>(), null, default));
        ...
        public async Task ApproveTeamMember_MemberNotFound()
        {
            ...
            var controller = new TeamController();
            moqs.SetupController(controller);
            var result = await controller.ApproveTeamMember(hackName, teamId, userId, default);
        ...
        public async Task ApproveTeamMember_Succeeded()
        {
            ...
            moqs.AuthorizationService.Setup(m => m.AuthorizeAsync(It.IsAny<ClaimsPrincipal>(), teamEntity, AuthConstant.Policy.TeamAdministrator))
                .ReturnsAsync(authResult);
            moqs.UserManagement.Setup(u => u.GetUserByIdAsync("uid", default)).ReturnsAsync(user);
            moqs.ActivityLogManagement.Setup(a => a.LogHackathonActivity("foo", "", ActivityLogType.approveTeamMember, It.IsAny<object>(), null, default));
            moqs.ActivityLogManagement.Setup(a => a.LogTeamActivity("foo", "tid", "", ActivityLogType.approveTeamMember, It.IsAny<object>(), null, default));
            moqs.ActivityLogManagement.Setup(a => a.LogUserActivity("", "foo", "", ActivityLogType.approveTeamMember, It.IsAny<object>(), null, default));
            moqs.ActivityLogManagement.Setup(a => a.LogUserActivity("uid", "foo", "", ActivityLogType.approveTeamMember, It.IsAny<object>(), nameof(Resources.ActivityLog_User_approveTeamMember2), default));
        ...
        public async Task DeleteTeam_HasAssignment()
        {
            ...
            moqs.HackathonManagement.Setup(p => p.GetHackathonEntityByNameAsync("foo", default)).ReturnsAsync(hackathon);
            moqs.TeamManagement.Setup(t => t.GetTeamByIdAsync("foo", "tid", default)).ReturnsAsync(teamEntity);
            moqs.AwardManagement.Setup(a => a.ListAssignmentsByTeamAsync("foo", "rk", default)).ReturnsAsync(assignments);
            moqs.AuthorizationService.Setup(m => m.AuthorizeAsync(It.IsAny<ClaimsPrincipal>(), teamEntity, AuthConstant.Policy.TeamAdministrator))
                .ReturnsAsync(authResult);
        ...
        public async Task DeleteTeam_Succeeded()
        {
            ...
            moqs.ActivityLogManagement.Setup(a => a.LogTeamActivity("foo", "tid", "", ActivityLogType.deleteTeamMember, It.IsAny<object>(), null, default));
            moqs.ActivityLogManagement.Setup(a => a.LogUserActivity("", "foo", "", ActivityLogType.deleteTeamMember, It.IsAny<object>(), null, default));
            moqs.ActivityLogManagement.Setup(a => a.LogUserActivity("u1", "foo", "", ActivityLogType.deleteTeamMember, It.IsAny<object>(), nameof(Resources.ActivityLog_User_deleteTeamMember2), default));
            moqs.ActivityLogManagement.Setup(a => a.LogUserActivity("u2", "foo", "", ActivityLogType.deleteTeamMember, It.IsAny<object>(), nameof(Resources.ActivityLog_User_deleteTeamMember2), default));
            ...
            // verify
            moqs.VerifyAll();
            moqs.ActivityLogManagement.Verify(a => a.LogHackathonActivity("foo", "", ActivityLogType.deleteTeamMember, It.IsAny<object>(), null, default), Times.Exactly(2));
            moqs.ActivityLogManagement.Verify(a => a.LogTeamActivity("foo", "tid", "", ActivityLogType.deleteTeamMember, It.IsAny<object>(), null, default), Times.Exactly(2));
            moqs.ActivityLogManagement.Verify(a => a.LogUserActivity("", "foo", "", ActivityLogType.deleteTeamMember, It.IsAny<object>(), null, default), Times.Exactly(2));
